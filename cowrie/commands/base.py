...
class command_ps(HoneyPotCommand):
    ...
    def call(self):
        ...
        output = (
            ...
            ('root      ', '   1', '    0', '   0',  '  0.0', '  0.1', '   2100', '   688', ' ?        ', 'Ss   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:07 ', 'init [2]  ',),
            ('root      ', '   2', '    0', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kthreadd]',),
            ('root      ', '   3', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[migration/0]',),
            ('root      ', '   4', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[ksoftirqd/0]',),
            ('root      ', '   5', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[watchdog/0]',),
            ('root      ', '   6', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:17 ', '[events/0]',),
            ('root      ', '   7', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[khelper]',),
            ('root      ', '  39', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kblockd/0]',),
            ('root      ', '  41', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kacpid]',),
            ('root      ', '  42', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kacpi_notify]',),
            ('root      ', ' 170', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kseriod]',),
            ('root      ', ' 207', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S    ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:01 ', '[pdflush]',),
            ('root      ', ' 208', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S    ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[pdflush]',),
            ('root      ', ' 209', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kswapd0]',),
            ('root      ', ' 210', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[aio/0]',),
            ('root      ', ' 748', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[ata/0]',),
            ('root      ', ' 749', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[ata_aux]',),
            ('root      ', ' 929', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[scsi_eh_0]',),
            ('root      ', '1014', '    1', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'D<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:03 ', '[kjournald]',),
            ('root      ', '1087', '    1', '   0',  '  0.0', '  0.1', '   2288', '   772', ' ?        ', 'S<s  ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', 'udevd --daemon',),
            ('root      ', '1553', '    2', '   0',  '  0.0', '  0.0', '      0', '     0', ' ?        ', 'S<   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '[kpsmoused]',),
            ('root      ', '2054', '    1', '   0',  '  0.0', '  0.2', '  28428', '  1508', ' ?        ', 'Sl   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:01 ', '/usr/sbin/rsyslogd -c3',),
            ('root      ', '2103', '    1', '   0',  '  0.0', '  0.2', '   2628', '  1196', ' tty1     ', 'Ss   ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '/bin/login --     ',),
            ('root      ', '2105', '    1', '   0',  '  0.0', '  0.0', '   1764', '   504', ' tty2     ', 'Ss+  ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '/sbin/getty 38400 tty2',),
            ('root      ', '2107', '    1', '   0',  '  0.0', '  0.0', '   1764', '   504', ' tty3     ', 'Ss+  ', '  '+ datetime.datetime.fromtimestamp(self.protocol.uptime()).strftime('%b:%d'), '   0:00 ', '/sbin/getty 38400 tty3',),
